 ...
 * @version 1.0
 */
public final class APXmlManifestParser {

    private APXmlManifestParser() {
    }
    ...
    public static String getApplicationName(String apkPath) {
        ...
        try {
            ...
            ZipEntry manifestXmlEntry = zipFile.getEntry(APXmlManifestReader.DEFAULT_XML);
            String manifestXML = APXmlManifestReader.getManifestXMLFromAPK(zipFile, manifestXmlEntry);
