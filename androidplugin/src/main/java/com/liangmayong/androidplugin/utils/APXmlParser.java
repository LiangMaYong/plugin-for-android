 ...
 * @version 1.0
 */
public class APXmlParser extends DefaultHandler {
    ...
    public static List<Map<String, String>> readXml(InputStream inStream, String nodeName) throws Exception {
        ...
        APXmlParser handler = new APXmlParser(nodeName);
    ...
    public static List<Map<String, String>> readXml(InputStream inStream, String nodeName, String[] form)
        ...
        SAXParserFactory spf = SAXParserFactory.newInstance();
        SAXParser saxParser = spf.newSAXParser();
        APXmlParser handler = new APXmlParser(nodeName, form);
        saxParser.parse(inStream, handler);
        inStream.close();
        return handler.getList();
    }

    private APXmlParser(String nodeName, String[] string) {
    ...
    private APXmlParser(String nodeName) {
        this.nodeName = nodeName;
    }
