 ...
 * @version 1.0
 */
public class APLayoutInflater extends LayoutInflater {
    ...
    public APLayoutInflater(LayoutInflater target) {
    ...
    private View createLayoutScreenSimple(int resource, ViewGroup root) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 14) {
            try {
                LinearLayout.class.getMethod("setFitsSystemWindows", boolean.class).invoke(lyt, true);
        ...
        try {
            ...
            layoutResource = layoutClass.getField("action_mode_bar").getInt(null);
        } catch (Throwable e) {
            APLog.d("APLayoutInflater", e);
        }
        {
            ...
            lyt.addView(viewStub, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
        ...
        flyt_content.setForegroundGravity(Gravity.FILL_HORIZONTAL | Gravity.TOP);
